## Приложение TODO (список дел) с подключенным Firebase в качестве бэкенда.
...
После завершения основной разработки, приложение было мною доработано по части UI и UX.
