 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class q{get(t){const e=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(e)){const t=new L;if(this.instancesDeferred.set(e,t),this.isInitialized(e)||this.shouldAutoInitialize())try{const n=this.getOrInitializeService({instanceIdentifier:e});n&&t.resolve(n)}catch(t){}}return this.instancesDeferred.get(e).promise}getImmediate(t){var e;const n=this.normalizeInstanceIdentifier(null==t?void 0:t.identifier),s=null!==(e=null==t?void 0:t.optional)&&void 0!==e&&e;if(!this.isInitialized(n)&&!this.shouldAutoInitialize()){if(s)return null;throw Error(`Service ${this.name} is not available`)}try{return this.getOrInitializeService({instanceIdentifier:n})}catch(t){if(s)return null;throw t}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,this.shouldAutoInitialize()){if(function(t){return"EAGER"===t.instantiationMode}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const _t=new O("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."});
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function At(t,e={}){let n=t;if("object"!=typeof e){e={name:e}}const s=Object.assign({name:vt,automaticDataCollectionEnabled:!1},e),i=s.name;if("string"!=typeof i||!i)throw _t.create("bad-app-name",{appName:String(i)});var r;if(n||(n=null===(r=N())||void 0===r?void 0:r.config),!n)throw _t.create("no-options");const o=Et.get(i);if(o){if(V(n,o.options)&&V(s,o.config))return o;throw _t.create("duplicate-app",{appName:i})}const a=new j(i);for(const t of bt.values())a.addComponent(t);const c=new Ct(n,s,a);return Et.set(i,c),c}function Dt(t=vt){const e=Et.get(t);if(!e&&t===vt)return At();if(!e)throw _t.create("no-app",{appName:t});return e}function Nt(t,e,n){var s;let i=null!==(s=wt[t])&&void 0!==s?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const t=[`Unable to register library "${i}" with version "${e}":`];return r&&t.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&t.push("and"),o&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),void yt.warn(t.join(" "))}It(new U(`${i}-version`,(()=>({library:i,version:e})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
const kt="firebase-heartbeat-store";let Lt=null;function Rt(){return Lt||(Lt=ut("firebase-heartbeat-database",1,{upgrade:(t,e)=>{if(0===e)t.createObjectStore(kt)}}).catch((t=>{throw _t.create("idb-open",{originalErrorMessage:t.message})}))),Lt}async function xt(t,e){try{const n=(await Rt()).transaction(kt,"readwrite"),s=n.objectStore(kt);return await s.put(e,Ot(t)),n.done}catch(t){if(t instanceof x)yt.warn(t.message);else{const e=_t.create("idb-set",{originalErrorMessage:null==t?void 0:t.message});yt.warn(e.message)}}}function Ot(t){return`${t.name}!${t.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mt{async triggerHeartbeat(){const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),e=Vt();if(null===this._heartbeatsCache&&(this._heartbeatsCache=await this._heartbeatsCachePromise),this._heartbeatsCache.lastSentHeartbeatDate!==e&&!this._heartbeatsCache.heartbeats.some((t=>t.date===e)))return this._heartbeatsCache.heartbeats.push({date:e,agent:t}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter((t=>{const e=new Date(t.date).valueOf();return Date.now()-e<=2592e6})),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null===this._heartbeatsCache||0===this._heartbeatsCache.heartbeats.length)return"";const t=Vt(),{heartbeatsToSend:e,unsentEntries:n}=function(t,e=1024){const n=[];let s=t.slice();for(const i of t){const t=n.find((t=>t.agent===i.agent));if(t){if(t.dates.push(i.date),Pt(n)>e){t.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),Pt(n)>e){n.pop();break}s=s.slice(1)}return{heartbeatsToSend:n,unsentEntries:s}}(this._heartbeatsCache.heartbeats),s=_(JSON.stringify({version:2,heartbeats:e}));return this._heartbeatsCache.lastSentHeartbeatDate=t,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}constructor(t){this.container=t,this._heartbeatsCache=null;const e=this.container.getProvider("app").getImmediate();this._storage=new Ft(e),this._heartbeatsCachePromise=this._storage.read().then((t=>(this._heartbeatsCache=t,t)))}}function Vt(){return(new Date).toISOString().substring(0,10)}class Ft{async runIndexedDBEnvironmentCheck(){return!!A()&&new Promise(((t,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(s);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(s),t(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var t;e((null===(t=i.error)||void 0===t?void 0:t.message)||"")}}catch(t){e(t)}})).then((()=>!0)).catch((()=>!1))}async read(){if(await this._canUseIndexedDBPromise){return await async function(t){try{return(await Rt()).transaction(kt).objectStore(kt).get(Ot(t))}catch(t){if(t instanceof x)yt.warn(t.message);else{const e=_t.create("idb-get",{originalErrorMessage:null==t?void 0:t.message});yt.warn(e.message)}}}(this.app)||{heartbeats:[]}}return{heartbeats:[]}}async overwrite(t){var e;if(await this._canUseIndexedDBPromise){const n=await this.read();return xt(this.app,{lastSentHeartbeatDate:null!==(e=t.lastSentHeartbeatDate)&&void 0!==e?e:n.lastSentHeartbeatDate,heartbeats:t.heartbeats})}}async add(t){var e;if(await this._canUseIndexedDBPromise){const n=await this.read();return xt(this.app,{lastSentHeartbeatDate:null!==(e=t.lastSentHeartbeatDate)&&void 0!==e?e:n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...t.heartbeats]})}}constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}}function Pt(t){return _(JSON.stringify({version:2,heartbeats:t})).length}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hi=new Y("@firebase/firestore");function zi(){return Hi.logLevel}function Qi(t,...e){if(Hi.logLevel<=K.DEBUG){const n=e.map(Xi);Hi.debug(`Firestore (${Gi}): ${t}`,...n)}}function Wi(t,...e){if(Hi.logLevel<=K.ERROR){const n=e.map(Xi);Hi.error(`Firestore (${Gi}): ${t}`,...n)}}function Yi(t,...e){if(Hi.logLevel<=K.WARN){const n=e.map(Xi);Hi.warn(`Firestore (${Gi}): ${t}`,...n)}}function Xi(t){if("string"==typeof t)return t;try{return e=t,JSON.stringify(e)}catch(e){return t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tr{static fromPath(t){return new Tr(wr.fromString(t))}static fromName(t){return new Tr(wr.fromString(t).popFirst(5))}static empty(){return new Tr(wr.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(t){return this.path.length>=2&&this.path.get(this.path.length-2)===t}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(t){return null!==t&&0===wr.comparator(this.path,t.path)}toString(){return this.path.toString()}static comparator(t,e){return wr.comparator(t.path,e.path)}static isDocumentKey(t){return t.length%2==0}static fromSegments(t){return new Tr(new wr(t.slice()))}constructor(t){this.path=t}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ir{constructor(t,e,n,s){this.indexId=t,this.collectionGroup=e,this.fields=n,this.indexState=s}}Ir.UNKNOWN_ID=-1;function Sr(t,e){const n=t.toTimestamp().seconds,s=t.toTimestamp().nanoseconds+1,i=yr.fromTimestamp(1e9===s?new mr(n+1,0):new mr(n,s));return new Cr(i,Tr.empty(),e)}function _r(t){return new Cr(t.readTime,t.key,-1)}class Cr{static min(){return new Cr(yr.min(),Tr.empty(),-1)}static max(){return new Cr(yr.max(),Tr.empty(),-1)}constructor(t,e,n){this.readTime=t,this.documentKey=e,this.largestBatchId=n}}function Ar(t,e){let n=t.readTime.compareTo(e.readTime);return 0!==n?n:(n=Tr.comparator(t.documentKey,e.documentKey),0!==n?n:pr(t.largestBatchId,e.largestBatchId))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mo{}class yo extends mo{static create(t,e,n){return t.isKeyField()?"in"===e||"not-in"===e?this.createKeyFieldInFilter(t,e,n):new _o(t,e,n):"array-contains"===e?new No(t,n):"in"===e?new ko(t,n):"not-in"===e?new Lo(t,n):"array-contains-any"===e?new Ro(t,n):new yo(t,e,n)}static createKeyFieldInFilter(t,e,n){return"in"===e?new Co(t,n):new Ao(t,n)}matches(t){const e=t.data.field(this.field);return"!="===this.op?null!==e&&this.matchesComparison(to(e,this.value)):null!==e&&Xr(this.value)===Xr(e)&&this.matchesComparison(to(e,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return 0===t;case"!=":return 0!==t;case">":return t>0;case">=":return t>=0;default:return Ji()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}getFirstInequalityField(){return this.isInequality()?this.field:null}constructor(t,e,n){super(),this.field=t,this.op=e,this.value=n}}class vo extends mo{static create(t,e){return new vo(t,e)}matches(t){return wo(this)?void 0===this.filters.find((e=>!e.matches(t))):void 0!==this.filters.find((e=>e.matches(t)))}getFlattenedFilters(){return null!==this.ht||(this.ht=this.filters.reduce(((t,e)=>t.concat(e.getFlattenedFilters())),[])),this.ht}getFilters(){return Object.assign([],this.filters)}getFirstInequalityField(){const t=this.lt((t=>t.isInequality()));return null!==t?t.field:null}lt(t){for(const e of this.getFlattenedFilters())if(t(e))return e;return null}constructor(t,e){super(),this.filters=t,this.op=e,this.ht=null}}function wo(t){return"and"===t.op}function Eo(t){return bo(t)&&wo(t)}function bo(t){for(const e of t.filters)if(e instanceof vo)return!1;return!0}function To(t){if(t instanceof yo)return t.field.canonicalString()+t.op.toString()+no(t.value);{const e=t.filters.map((t=>To(t))).join(",");return`${t.op}(${e})`}}function Io(t,e){return t instanceof yo?function(t,e){return e instanceof yo&&t.op===e.op&&t.field.isEqual(e.field)&&Jr(t.value,e.value)}(t,e):t instanceof vo?function(t,e){return e instanceof vo&&t.op===e.op&&t.filters.length===e.filters.length&&t.filters.reduce(((t,n,s)=>t&&Io(n,e.filters[s])),!0)}(t,e):void Ji()}function So(t){return t instanceof yo?function(t){return`${t.field.canonicalString()} ${t.op} ${no(t.value)}`}(t):t instanceof vo?function(t){return t.op.toString()+" {"+t.getFilters().map(So).join(" ,")+"}"}(t):"Filter"}class _o extends yo{matches(t){const e=Tr.comparator(t.key,this.key);return this.matchesComparison(e)}constructor(t,e,n){super(t,e,n),this.key=Tr.fromName(n.referenceValue)}}class Co extends yo{matches(t){return this.keys.some((e=>e.isEqual(t.key)))}constructor(t,e){super(t,"in",e),this.keys=Do("in",e)}}class Ao extends yo{matches(t){return!this.keys.some((e=>e.isEqual(t.key)))}constructor(t,e){super(t,"not-in",e),this.keys=Do("not-in",e)}}function Do(t,e){var n;return((null===(n=e.arrayValue)||void 0===n?void 0:n.values)||[]).map((t=>Tr.fromName(t.referenceValue)))}class No extends yo{matches(t){const e=t.data.field(this.field);return oo(e)&&Zr(e.arrayValue,this.value)}constructor(t,e){super(t,"array-contains",e)}}class ko extends yo{matches(t){const e=t.data.field(this.field);return null!==e&&Zr(this.value.arrayValue,e)}constructor(t,e){super(t,"in",e)}}class Lo extends yo{matches(t){if(Zr(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const e=t.data.field(this.field);return null!==e&&!Zr(this.value.arrayValue,e)}constructor(t,e){super(t,"not-in",e)}}class Ro extends yo{matches(t){const e=t.data.field(this.field);return!(!oo(e)||!e.arrayValue.values)&&e.arrayValue.values.some((t=>Zr(this.value.arrayValue,t)))}constructor(t,e){super(t,"array-contains-any",e)}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
class Bo{static empty(){return new Bo([])}unionWith(t){let e=new Po(br.comparator);for(const t of this.fields)e=e.add(t);for(const n of t)e=e.add(n);return new Bo(e.toArray())}covers(t){for(const e of this.fields)if(e.isPrefixOf(t))return!0;return!1}isEqual(t){return gr(this.fields,t.fields,((t,e)=>t.isEqual(e)))}constructor(t){this.fields=t,t.sort(br.comparator)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ma{constructor(){this._=void 0}}function ya(t,e,n){return t instanceof Ea?function(t,e){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:t.seconds,nanos:t.nanoseconds}}}};return e&&(n.fields.__previous_value__=e),{mapValue:n}}(n,e):t instanceof ba?Ta(t,e):t instanceof Ia?Sa(t,e):function(t,e){const n=wa(t,e),s=Ca(n)+Ca(t.gt);return ro(n)&&ro(t.gt)?pa(s):fa(t.yt,s)}(t,e)}function va(t,e,n){return t instanceof ba?Ta(t,e):t instanceof Ia?Sa(t,e):n}function wa(t,e){var n;return t instanceof _a?ro(n=e)||function(t){return!!t&&"doubleValue"in t}(n)?e:{integerValue:0}:null}class Ea extends ma{}class ba extends ma{constructor(t){super(),this.elements=t}}function Ta(t,e){const n=Aa(e);for(const e of t.elements)n.some((t=>Jr(t,e)))||n.push(e);return{arrayValue:{values:n}}}class Ia extends ma{constructor(t){super(),this.elements=t}}function Sa(t,e){let n=Aa(e);for(const e of t.elements)n=n.filter((t=>!Jr(t,e)));return{arrayValue:{values:n}}}class _a extends ma{constructor(t,e){super(),this.yt=t,this.gt=e}}function Ca(t){return Gr(t.integerValue||t.doubleValue)}function Aa(t){return oo(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Da{constructor(t,e){this.field=t,this.transform=e}}class Na{constructor(t,e){this.version=t,this.transformResults=e}}class ka{static none(){return new ka}static exists(t){return new ka(void 0,t)}static updateTime(t){return new ka(t)}get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(t){return this.exists===t.exists&&(this.updateTime?!!t.updateTime&&this.updateTime.isEqual(t.updateTime):!t.updateTime)}constructor(t,e){this.updateTime=t,this.exists=e}}function La(t,e){return void 0!==t.updateTime?e.isFoundDocument()&&e.version.isEqual(t.updateTime):void 0===t.exists||t.exists===e.isFoundDocument()}class Ra{}function xa(t,e){if(!t.hasLocalMutations||e&&0===e.fields.length)return null;if(null===e)return t.isNoDocument()?new $a(t.key,ka.none()):new Pa(t.key,t.data,ka.none());{const n=t.data,s=qo.empty();let i=new Po(br.comparator);for(let t of e.fields)if(!i.has(t)){let e=n.field(t);null===e&&t.length>1&&(t=t.popLast(),e=n.field(t)),null===e?s.delete(t):s.set(t,e),i=i.add(t)}return new Ua(t.key,s,new Bo(i.toArray()),ka.none())}}function Oa(t,e,n){t instanceof Pa?function(t,e,n){const s=t.value.clone(),i=qa(t.fieldTransforms,e,n.transformResults);s.setAll(i),e.convertToFoundDocument(n.version,s).setHasCommittedMutations()}(t,e,n):t instanceof Ua?function(t,e,n){if(!La(t.precondition,e))return void e.convertToUnknownDocument(n.version);const s=qa(t.fieldTransforms,e,n.transformResults),i=e.data;i.setAll(Ba(t)),i.setAll(s),e.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(t,e,n):function(t,e,n){e.convertToNoDocument(n.version).setHasCommittedMutations()}(0,e,n)}function Ma(t,e,n,s){return t instanceof Pa?function(t,e,n,s){if(!La(t.precondition,e))return n;const i=t.value.clone(),r=ja(t.fieldTransforms,s,e);return i.setAll(r),e.convertToFoundDocument(e.version,i).setHasLocalMutations(),null}(t,e,n,s):t instanceof Ua?function(t,e,n,s){if(!La(t.precondition,e))return n;const i=ja(t.fieldTransforms,s,e),r=e.data;return r.setAll(Ba(t)),r.setAll(i),e.convertToFoundDocument(e.version,r).setHasLocalMutations(),null===n?null:n.unionWith(t.fieldMask.fields).unionWith(t.fieldTransforms.map((t=>t.field)))}(t,e,n,s):function(t,e,n){return La(t.precondition,e)?(e.convertToNoDocument(e.version).setHasLocalMutations(),null):n}(t,e,n)}function Va(t,e){let n=null;for(const s of t.fieldTransforms){const t=e.data.field(s.field),i=wa(s.transform,t||null);null!=i&&(null===n&&(n=qo.empty()),n.set(s.field,i))}return n||null}function Fa(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!function(t,e){return void 0===t&&void 0===e||!(!t||!e)&&gr(t,e,((t,e)=>function(t,e){return t.field.isEqual(e.field)&&function(t,e){return t instanceof ba&&e instanceof ba||t instanceof Ia&&e instanceof Ia?gr(t.elements,e.elements,Jr):t instanceof _a&&e instanceof _a?Jr(t.gt,e.gt):t instanceof Ea&&e instanceof Ea}(t.transform,e.transform)}(t,e)))}(t.fieldTransforms,e.fieldTransforms)&&(0===t.type?t.value.isEqual(e.value):1!==t.type||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}class Pa extends Ra{getFieldMask(){return null}constructor(t,e,n,s=[]){super(),this.key=t,this.value=e,this.precondition=n,this.fieldTransforms=s,this.type=0}}class Ua extends Ra{getFieldMask(){return this.fieldMask}constructor(t,e,n,s,i=[]){super(),this.key=t,this.data=e,this.fieldMask=n,this.precondition=s,this.fieldTransforms=i,this.type=1}}function Ba(t){const e=new Map;return t.fieldMask.fields.forEach((n=>{if(!n.isEmpty()){const s=t.data.field(n);e.set(n,s)}})),e}function qa(t,e,n){const s=new Map;Zi(t.length===n.length);for(let i=0;i<n.length;i++){const r=t[i],o=r.transform,a=e.data.field(r.field);s.set(r.field,va(o,a,n[i]))}return s}function ja(t,e,n){const s=new Map;for(const i of t){const t=i.transform,r=n.data.field(i.field);s.set(i.field,ya(t,r,e))}return s}class $a extends Ra{getFieldMask(){return null}constructor(t,e){super(),this.key=t,this.precondition=e,this.type=2,this.fieldTransforms=[]}}class Ka extends Ra{getFieldMask(){return null}constructor(t,e){super(),this.key=t,this.precondition=e,this.type=3,this.fieldTransforms=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xa=new Mo(Tr.comparator);function Ja(){return Xa}const Za=new Mo(Tr.comparator);function tc(...t){let e=Za;for(const n of t)e=e.insert(n.key,n);return e}function ec(t){let e=Za;return t.forEach(((t,n)=>e=e.insert(t,n.overlayedDocument))),e}function nc(){return ic()}function sc(){return ic()}function ic(){return new Ya((t=>t.toString()),((t,e)=>t.isEqual(e)))}const rc=new Mo(Tr.comparator),oc=new Po(Tr.comparator);function ac(...t){let e=oc;for(const n of t)e=e.add(n);return e}const cc=new Po(pr);function uc(){return cc}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ru{addToCollectionParentIndex(t,e){return this.Je.add(e),Lr.resolve()}getCollectionParents(t,e){return Lr.resolve(this.Je.getEntries(e))}addFieldIndex(t,e){return Lr.resolve()}deleteFieldIndex(t,e){return Lr.resolve()}getDocumentsMatchingTarget(t,e){return Lr.resolve(null)}getIndexType(t,e){return Lr.resolve(0)}getFieldIndexes(t,e){return Lr.resolve([])}getNextCollectionGroupToUpdate(t){return Lr.resolve(null)}getMinOffset(t,e){return Lr.resolve(Cr.min())}getMinOffsetFromCollectionGroup(t,e){return Lr.resolve(Cr.min())}updateCollectionGroup(t,e,n){return Lr.resolve()}updateIndexEntries(t,e){return Lr.resolve()}constructor(){this.Je=new ou}}class ou{add(t){const e=t.lastSegment(),n=t.popLast(),s=this.index[e]||new Po(wr.comparator),i=!s.has(n);return this.index[e]=s.add(n),i}has(t){const e=t.lastSegment(),n=t.popLast(),s=this.index[e];return s&&s.has(n)}getEntries(t){return(this.index[t]||new Po(wr.comparator)).toArray()}constructor(){this.index={}}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class uu{addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,$o.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const n=this.changes.get(e);return void 0!==n?Lr.resolve(n):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}constructor(){this.changes=new Ya((t=>t.toString()),((t,e)=>t.isEqual(e))),this.changesApplied=!1}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class du{getBundleMetadata(t,e){return Lr.resolve(this.Zn.get(e))}saveBundleMetadata(t,e){var n;return this.Zn.set(e.id,{id:(n=e).id,version:n.version,createTime:Cc(n.createTime)}),Lr.resolve()}getNamedQuery(t,e){return Lr.resolve(this.ts.get(e))}saveNamedQuery(t,e){return this.ts.set(e.name,function(t){return{name:t.name,query:su(t.bundledQuery),readTime:Cc(t.readTime)}}(e)),Lr.resolve()}constructor(t){this.yt=t,this.Zn=new Map,this.ts=new Map}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fu{getOverlay(t,e){return Lr.resolve(this.overlays.get(e))}getOverlays(t,e){const n=nc();return Lr.forEach(e,(e=>this.getOverlay(t,e).next((t=>{null!==t&&n.set(e,t)})))).next((()=>n))}saveOverlays(t,e,n){return n.forEach(((n,s)=>{this.oe(t,e,s)})),Lr.resolve()}removeOverlaysForBatchId(t,e,n){const s=this.es.get(n);return void 0!==s&&(s.forEach((t=>this.overlays=this.overlays.remove(t))),this.es.delete(n)),Lr.resolve()}getOverlaysForCollection(t,e,n){const s=nc(),i=e.length+1,r=new Tr(e.child("")),o=this.overlays.getIteratorFrom(r);for(;o.hasNext();){const t=o.getNext().value,r=t.getKey();if(!e.isPrefixOf(r.path))break;r.path.length===i&&t.largestBatchId>n&&s.set(t.getKey(),t)}return Lr.resolve(s)}getOverlaysForCollectionGroup(t,e,n,s){let i=new Mo(((t,e)=>t-e));const r=this.overlays.getIterator();for(;r.hasNext();){const t=r.getNext().value;if(t.getKey().getCollectionGroup()===e&&t.largestBatchId>n){let e=i.get(t.largestBatchId);null===e&&(e=nc(),i=i.insert(t.largestBatchId,e)),e.set(t.getKey(),t)}}const o=nc(),a=i.getIterator();for(;a.hasNext()&&(a.getNext().value.forEach(((t,e)=>o.set(t,e))),!(o.size()>=s)););return Lr.resolve(o)}oe(t,e,n){const s=this.overlays.get(n.key);if(null!==s){const t=this.es.get(s.largestBatchId).delete(n.key);this.es.set(s.largestBatchId,t)}this.overlays=this.overlays.insert(n.key,new tu(e,n));let i=this.es.get(e);void 0===i&&(i=ac(),this.es.set(e,i)),this.es.set(e,i.add(n.key))}constructor(){this.overlays=new Mo(Tr.comparator),this.es=new Map}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pu{isEmpty(){return this.ns.isEmpty()}addReference(t,e){const n=new gu(t,e);this.ns=this.ns.add(n),this.rs=this.rs.add(n)}us(t,e){t.forEach((t=>this.addReference(t,e)))}removeReference(t,e){this.cs(new gu(t,e))}hs(t,e){t.forEach((t=>this.removeReference(t,e)))}ls(t){const e=new Tr(new wr([])),n=new gu(e,t),s=new gu(e,t+1),i=[];return this.rs.forEachInRange([n,s],(t=>{this.cs(t),i.push(t.key)})),i}fs(){this.ns.forEach((t=>this.cs(t)))}cs(t){this.ns=this.ns.delete(t),this.rs=this.rs.delete(t)}ds(t){const e=new Tr(new wr([])),n=new gu(e,t),s=new gu(e,t+1);let i=ac();return this.rs.forEachInRange([n,s],(t=>{i=i.add(t.key)})),i}containsKey(t){const e=new gu(t,0),n=this.ns.firstAfterOrEqual(e);return null!==n&&t.isEqual(n.key)}constructor(){this.ns=new Po(gu.ss),this.rs=new Po(gu.os)}}class gu{static ss(t,e){return Tr.comparator(t.key,e.key)||pr(t._s,e._s)}static os(t,e){return pr(t._s,e._s)||Tr.comparator(t.key,e.key)}constructor(t,e){this.key=t,this._s=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eu{start(){return Promise.resolve()}shutdown(){return this.Ds=!1,Promise.resolve()}get started(){return this.Ds}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new fu,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let n=this.Vs[t.toKey()];return n||(n=new mu(e,this.referenceDelegate),this.Vs[t.toKey()]=n),n}getTargetCache(){return this.Cs}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ns}runTransaction(t,e,n){Qi("MemoryPersistence","Starting transaction:",t);const s=new bu(this.Ss.next());return this.referenceDelegate.ks(),n(s).next((t=>this.referenceDelegate.Os(s).next((()=>t)))).toPromise().then((t=>(s.raiseOnCommittedEvent(),t)))}Ms(t,e){return Lr.or(Object.values(this.Vs).map((n=>()=>n.containsKey(t,e))))}constructor(t,e){this.Vs={},this.overlays={},this.Ss=new xr(0),this.Ds=!1,this.Ds=!0,this.referenceDelegate=t(this),this.Cs=new wu(this),this.indexManager=new ru,this.remoteDocumentCache=function(t){return new yu(t)}((t=>this.referenceDelegate.xs(t))),this.yt=new nu(e),this.Ns=new du(this.yt)}}class bu extends Nr{constructor(t){super(),this.currentSequenceNumber=t}}class Tu{static Bs(t){return new Tu(t)}get Ls(){if(this.$s)return this.$s;throw Ji()}addReference(t,e,n){return this.Fs.addReference(n,e),this.Ls.delete(n.toString()),Lr.resolve()}removeReference(t,e,n){return this.Fs.removeReference(n,e),this.Ls.add(n.toString()),Lr.resolve()}markPotentiallyOrphaned(t,e){return this.Ls.add(e.toString()),Lr.resolve()}removeTarget(t,e){this.Fs.ls(e.targetId).forEach((t=>this.Ls.add(t.toString())));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(t,e.targetId).next((t=>{t.forEach((t=>this.Ls.add(t.toString())))})).next((()=>n.removeTargetData(t,e)))}ks(){this.$s=new Set}Os(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Lr.forEach(this.Ls,(n=>{const s=Tr.fromPath(n);return this.qs(t,s).next((t=>{t||e.removeEntry(s,yr.min())}))})).next((()=>(this.$s=null,e.apply(t))))}updateLimboDocument(t,e){return this.qs(t,e).next((t=>{t?this.Ls.delete(e.toString()):this.Ls.add(e.toString())}))}xs(t){return 0}qs(t,e){return Lr.or([()=>Lr.resolve(this.Fs.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Ms(t,e)])}constructor(t){this.persistence=t,this.Fs=new pu,this.$s=null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Su{initialize(t,e){this.Ni=t,this.indexManager=e,this.xi=!0}getDocumentsMatchingQuery(t,e,n,s){return this.ki(t,e).next((i=>i||this.Oi(t,e,s,n))).next((n=>n||this.Mi(t,e)))}ki(t,e){if(Jo(e))return Lr.resolve(null);let n=sa(e);return this.indexManager.getIndexType(t,n).next((s=>0===s?null:(null!==e.limit&&1===s&&(e=ra(e,null,"F"),n=sa(e)),this.indexManager.getDocumentsMatchingTarget(t,n).next((s=>{const i=ac(...s);return this.Ni.getDocuments(t,i).next((s=>this.indexManager.getMinOffset(t,n).next((n=>{const r=this.Fi(e,s);return this.$i(e,r,i,n.readTime)?this.ki(t,ra(e,null,"F")):this.Bi(t,r,e,n)}))))})))))}Oi(t,e,n,s){return Jo(e)||s.isEqual(yr.min())?this.Mi(t,e):this.Ni.getDocuments(t,n).next((i=>{const r=this.Fi(e,i);return this.$i(e,r,n,s)?this.Mi(t,e):(zi()<=K.DEBUG&&Qi("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),ca(e)),this.Bi(t,r,e,Sr(s,-1)))}))}Fi(t,e){let n=new Po(la(t));return e.forEach(((e,s)=>{ua(t,s)&&(n=n.add(s))})),n}$i(t,e,n,s){if(null===t.limit)return!1;if(n.size!==e.size)return!0;const i="F"===t.limitType?e.last():e.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Mi(t,e){return zi()<=K.DEBUG&&Qi("QueryEngine","Using full collection scan to execute query:",ca(e)),this.Ni.getDocumentsMatchingQuery(t,e,Cr.min())}Bi(t,e,n,s){return this.Ni.getDocumentsMatchingQuery(t,n,s).next((t=>(e.forEach((e=>{t=t.insert(e.key,e)})),t)))}constructor(){this.xi=!1}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bl{get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Il(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new bl(this.firestore,t,this._key)}constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}}class Tl{withConverter(t){return new Tl(this.firestore,t,this._query)}constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}}class Il extends Tl{get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new bl(this.firestore,null,new Tr(t))}withConverter(t){return new Il(this.firestore,t,this._path)}constructor(t,e,n){super(t,e,Xo(n)),this._path=n,this.type="collection"}}function Sl(t,e,...n){if(t=P(t),1===arguments.length&&(e=fr.R()),dl("doc","path",e),t instanceof wl){const s=wr.fromString(e,...n);return fl(s),new bl(t,null,new Tr(s))}{if(!(t instanceof bl||t instanceof Il))throw new nr(er.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(wr.fromString(e,...n));return fl(s),new bl(t.firestore,t instanceof Il?t.converter:null,new Tr(s))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class _l{next(t){this.observer.next&&this.Rc(this.observer.next,t)}error(t){this.observer.error?this.Rc(this.observer.error,t):Wi("Uncaught Error in snapshot listener:",t.toString())}bc(){this.muted=!0}Rc(t,e){this.muted||setTimeout((()=>{this.muted||t(e)}),0)}constructor(t){this.observer=t,this.muted=!1}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bl{isEqual(t){return this._internalPath.isEqual(t._internalPath)}constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new nr(er.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new br(t)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Md(t){return Fl(t=ml(t,Ml)),new xd(t,(e=>Rd(t,e)))
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}!function(t,e=!0){!function(t){Gi=t}("9.15.0"),It(new U("firestore",((t,{instanceIdentifier:n,options:s})=>{const i=t.getProvider("app").getImmediate(),r=new Ml(new ar(t.getProvider("auth-internal")),new lr(t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new nr(er.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Mr(t.options.projectId,e)}(i,n),i);return s=Object.assign({useFetchStreams:e},s),r._setSettings(s),r}),"PUBLIC").setMultipleInstances(!0)),Nt($i,"3.8.0",t),Nt($i,"3.8.0","esm2017")}();const Vd={apiKey:"AIzaSyDjnP0mURxbRQeo7rzj3UL4To_UzkSDHdE",authDomain:"todo-9ffce.firebaseapp.com",projectId:"todo-9ffce",storageBucket:"todo-9ffce.appspot.com",messagingSenderId:"267563520710",appId:"1:267563520710:web:f765d69ec7bec2c0903dc7"};const Fd=document.querySelector(".js-input"),Pd=document.querySelector(".js-btn"),Ud=document.querySelector(".js-output"),Bd=document.querySelector(".js-clear-btn"),qd=document.querySelector(".js-counter"),jd=document.querySelector(".js-btn-up"),$d=document.querySelector(".js-btn-down"),Kd=document.querySelector(".js-form"),Gd=document.querySelector(".js-footer_container"),Hd={todosIds:[],todosById:{},addTodo:function({title:t}){const e={title:t,done:!1,id:a()};return this.todosIds.push(e.id),this.todosById[e.id]=e,e},setTodos:function(t){this.todosIds=[],this.todosById={},t.forEach((t=>{this.todosIds.push(t.id),this.todosById[t.id]=t}))},getTodos:function(){return{todosById:this.todosById,todosIds:this.todosIds}},toggleTodo:function(t){this.todosById[t].done=!this.todosById[t].done},getTodo:function(t){return this.todosById[t]}},zd=(Qd=".js-output",Wd=function(t){Hd.toggleTodo(t),Yd.update(Hd.getTodo(t)),document.getElementById(t+1).classList.toggle("cross-line")},{node:document.querySelector(Qd),renderTodos:function({todosIds:t,todosById:e}){t.forEach((t=>{this.addTodo(e[t])}))},clearTodos:function(){this.node.innerHTML=""},clearTodosOne:function(t){document.getElementById(t+1).style.display="none"},addTodo:function(t){const e=document.createElement("div"),n=document.createElement("input"),s=document.createElement("label"),i=document.createElement("button");n.setAttribute("type","checkbox"),n.setAttribute("id",t.id),n.onclick=()=>{Wd(t.id)},i.onclick=()=>{var e;e=t.id,Yd.deleteOne(e),zd.clearTodosOne(e),tf("-"),nf()},t.done&&(n.setAttribute("checked",!0),e.classList.add("cross-line")),e.setAttribute("id",t.id+1),i.setAttribute("id",t.id+1),i.innerText="×",s.innerText=t.title,s.setAttribute("for",t.id),e.append(n,s,i),this.node.append(e)}});var Qd,Wd;const Yd={key:"todos",db:Vl(At(Vd)),pull:async function(){const t=function(t,e,...n){let s=[];e instanceof gd&&s.push(e),s=s.concat(n),function(t){const e=t.filter((t=>t instanceof vd)).length,n=t.filter((t=>t instanceof yd)).length;if(e>1||e>0&&n>0)throw new nr(er.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(s);for(const e of s)t=e._apply(t);return t}(function(t,e,...n){if(t=P(t),dl("collection","path",e),t instanceof wl){const s=wr.fromString(e,...n);return pl(s),new Il(t,null,s)}{if(!(t instanceof bl||t instanceof Il))throw new nr(er.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=t._path.child(wr.fromString(e,...n));return pl(s),new Il(t.firestore,null,s)}}(this.db,this.key),function(t,e="asc"){const n=e,s=fd("orderBy",t);return wd._create(s,n)}("createdAt")),e=await function(t){t=ml(t,Tl);const e=ml(t.firestore,Ml),n=Fl(e),s=new Ld(e);return pd(t._query),xl(n,t._query).then((n=>new Nd(e,s,t,n)))}(t),n=[];return e.forEach((t=>{n.push({id:t.id,title:t.data().title,done:t.data().done})})),n},push:async function(t){try{await function(t,e,n){t=ml(t,bl);const s=ml(t.firestore,Ml),i=_d(t.converter,e,n);return Rd(s,[Yl(Wl(s),"setDoc",t._key,i,null!==t.converter,n).toMutation(t._key,ka.none())])}(Sl(this.db,this.key,t.id),{title:t.title,done:t.done,createdAt:new Jl("serverTimestamp")})}catch(t){console.error("Error adding document: ",t)}},delete:async function({todosIds:t}){const e=Md(this.db);t.forEach((t=>{const n=Sl(this.db,this.key,t);e.delete(n)})),await e.commit()},deleteOne:async function(t){const e=Md(this.db),n=Sl(this.db,this.key,t);e.delete(n),await e.commit()},update:async function(t){const e=Sl(this.db,this.key,t.id);await function(t,e,n,...s){t=ml(t,bl);const i=ml(t.firestore,Ml),r=Wl(i);let o;return o="string"==typeof(e=P(e))||e instanceof Bl?td(r,"updateDoc",t._key,e,n,s):Zl(r,"updateDoc",t._key,e),Rd(i,[o.toMutation(t._key,ka.exists(!0))])}(e,{done:t.done})}};const Xd=Kd.offsetTop,Jd=ef();let Zd=0;function tf(t){switch(t){case"+":Zd+=1;break;case"-":Zd-=1;break;case"0":Zd=0,console.log(t,Zd);break;case"render":Zd=Ud.children.length}qd.innerText=Zd}function ef(){return Math.max(document.body.scrollHeight,document.documentElement.scrollHeight,document.body.offsetHeight,document.documentElement.offsetHeight,document.body.clientHeight,document.documentElement.clientHeight)}function nf(){ef()>Jd?(Gd.style.position="fixed",Gd.style.bottom="0"):Gd.style.position="static"}function sf(){let t=pageYOffset;ef()>Jd+t?rf("down",1):ef()==Jd+t&&rf("down",0)}function rf(t,e){"up"===t&&(1===e?(jd.style.opacity=".6",jd.style.cursor="pointer"):0===e&&(jd.style.opacity="0",jd.style.cursor="default")),"down"===t&&(1===e?($d.style.opacity=".6",jd.style.cursor="pointer"):0===e&&($d.style.opacity="0",jd.style.cursor="default"))}Yd.pull().then((t=>{Hd.setTodos(t),zd.renderTodos(Hd.getTodos()),tf("render"),nf(),sf()})),Fd.addEventListener("keydown",(function(t){const e=t.target.value;"Enter"===t.key&&e.length>0?(t.preventDefault(),Pd.click(),nf()):"Enter"===t.key&&e.length<=0&&t.preventDefault()})),Pd.addEventListener("click",(function(){const t=Fd.value;if(t){const e=Hd.addTodo({title:t});zd.addTodo(e),Yd.push(e),tf("+"),nf(),window.scrollTo(0,ef())}})),window.addEventListener("scroll",(function(){let t=pageYOffset;!function(t,e){t<=e?(Kd.style.position="fixed",Kd.style.top="0"):t>e&&(Kd.style.position="static")}(Xd,t),sf(),function(){let t=pageYOffset;t>=Xd+82?rf("up",1):t<Xd+82&&rf("up",0)}()})),Bd.addEventListener("click",(function(){Yd.delete(Hd.getTodos()),Hd.setTodos([]),zd.clearTodos(),tf("0"),nf()})),jd.addEventListener("click",(function(){window.scrollTo(0,Xd)})),$d.addEventListener("click",(function(){window.scrollTo(0,ef())}))}();